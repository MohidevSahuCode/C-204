...
def askPlayerName():
    ...
    bg = ImageTk.PhotoImage(file="E:/Ludo server/Client/assets/background.png")

    canvas1 = Canvas(nameWindow,width=500,height=500)
    canvas1.pack(fill='both',expand=True)
    #Display Image
    canvas1.create_image(0,0,image=bg,anchor='nw')
    canvas1.create_text(screen_width/2,screen_height/2,text="Enter Name",font=('Chalkboard SE',100),fill='white')
